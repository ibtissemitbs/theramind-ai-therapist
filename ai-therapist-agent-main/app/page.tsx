...
export default function Home() {
  // ✅ refactor: emoji séparé du libellé (finis les split(" "))
  const emotions = [
    { value: 0, emoji: "😔", label: "Triste", color: "from-blue-500/50" },
    { value: 25, emoji: "🙂", label: "Plutôt bien", color: "from-green-500/50" },
    { value: 50, emoji: "😌", label: "Paisible", color: "from-purple-500/50" },
    { value: 75, emoji: "😊", label: "Heureux(se)", color: "from-yellow-500/50" },
    { value: 100, emoji: "✨", label: "Enthousiaste", color: "from-pink-500/50" },
  ];
  ...
  const welcomeSteps = [
    {
      title: "Bonjour, je suis votre compagnon IA 👋",
      description:
        "Un espace bienveillant et sans jugement pour vous exprimer. Je vous écoute et je vous accompagne.",
      icon: Waves,
    },
    {
      title: "Soutien personnalisé 🌱",
      description:
        "Je m’adapte à vos besoins et à votre état émotionnel, avec des techniques éprouvées et des conseils doux.",
      icon: Brain,
    },
    {
      title: "Votre confidentialité avant tout 🛡️",
      description:
        "Nos échanges sont privés et sécurisés. Je respecte des principes éthiques stricts et vos limites.",
      icon: Shield,
    },
  ];
  ...
  /*const features = [
    {
      icon: HeartPulse,
      title: "Présence 24/7",
      description: "Toujours là pour vous écouter, à toute heure",
    ...
    },
    {
      ...
      description: "Guidance personnalisée par une IA empathique",
    ...
    },
    {
      ...
      description: "Vos conversations restent confidentielles et chiffrées",
      color: "from-emerald-500/20",
      delay: 0.6,
    },
    {
      icon: MessageSquareHeart,
      title: "Basé sur l’évidence",
      description: "Techniques d’accompagnement fondées sur la recherche",
      ...
      <section className="relative min-h-[90vh] mt-20 flex flex-col items-center justify-center py-12 px-4">
        ...
        >
          ...
          <p className="max-w-[600px] mx-auto text-base md:text-lg text-muted-foreground leading-relaxed tracking-wide">
            Découvrez un nouveau type de soutien émotionnel. Notre compagnon IA
            vous écoute, vous comprend et vous guide sur votre parcours de vie.
          </p>
          ...
          >
            <div className="space-y-2 text-center">
              <p className="text-sm text-muted-foreground/80 font-medium">
                Quel que soit votre ressenti, nous sommes là pour écouter
              </p>
            ...
            <div className="text-center">
              <p className="text-sm text-muted-foreground animate-pulse">
                Faites glisser pour exprimer votre humeur du jour
              </p>
            </div>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto">
          <motion.div className="text-center mb-16 space-y-4">
            <h2 className="text-3xl font-bold bg-gradient-to-r from-primary/90 to-primary bg-clip-text text-transparent">
              Comment l’application vous aide
            </h2>
            <p className="text-foreground/90 max-w-2xl mx-auto font-medium text-lg">
              Un accompagnement émotionnel nouvelle génération, propulsé par une IA empathique
            </p>
          </motion.div>
            ...
            <Button
              onClick={() => {
                if (currentStep < welcomeSteps.length - 1) {
                  ...
                  setShowDialog(false);
                  setCurrentStep(0);
                  // rediriger vers le chat ici si besoin
                }
              }}
